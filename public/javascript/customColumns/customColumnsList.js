...
(function() {
    ...
    const customColumnForm = document.getElementById("customColumnSubmitter");
    const columnNameInput = document.getElementById("column-name");
    const columnTypeInput = document.getElementById("column-type");
    const columnNumberBlock = document.getElementById("column-number-block");
    const columnNumberMinInput = document.getElementById("column-number-min");
    const columnNumberMaxInput = document.getElementById("column-number-max");
